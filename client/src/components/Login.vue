        ...
        <div class="w-100" style="max-width: 600px;">
            <div class="card-body text-center">
                <form @submit.prevent="processLogin">
                    ...
                    <input :type="canSeePwd ? 'text' : 'password'" placeholder="Password" name="password" id="password"
                        class="form-control mb-1" v-model="student.password">
                    <div>
                ...
                <small>Dont have an account? Create one <a href="/register">here</a></small>
