...
<template>
    ...
    <div class="container mt-3">
        ...
        <DataTable :value="filteredRequests" @row-click="cellClicked($event.data)" stripedRows columnResizeMode="fit"
            removableSort paginator :rows="15" :rowsPerPageOptions="[15, 25, 50, 100]"
            ...
            <Column header="Actions" style="width: 20%; text-align: center;">
                <template #body="rowData">
                    <button @click="editProduct(rowData)" data-bs-toggle="modal" data-bs-target="#categoryUpdateModal"
                        class="btn">
